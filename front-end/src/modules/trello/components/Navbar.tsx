			...
			<div className="d-flex align-items-center justify-content-between w-100">
					...
					>
						<div className="plannr-logo-icon me-2 d-flex align-items-center justify-content-center">
							...
							>
								...
								/>
								<path
									d="M24.5 17.5H18.6667C18.0223 17.5 17.5 18.0223 17.5 18.6667V24.5C17.5 25.1443 18.0223 25.6667 18.6667 25.6667H24.5C25.1443 25.6667 25.6667 25.1443 25.6667 24.5V18.6667C25.6667 18.0223 25.1443 17.5 24.5 17.5Z"
									stroke="white"
									strokeWidth="2"
									strokeLinecap="round"
								/>
								<path
									d="M37.3333 17.5H31.5C30.8557 17.5 30.3333 18.0223 30.3333 18.6667V24.5C30.3333 25.1443 30.8557 25.6667 31.5 25.6667H37.3333C37.9777 25.6667 38.5 25.1443 38.5 24.5V18.6667C38.5 18.0223 37.9777 17.5 37.3333 17.5Z"
									stroke="white"
									strokeWidth="2"
									strokeLinecap="round"
								/>
								<path
									d="M37.3333 30.3333H31.5C30.8557 30.3333 30.3333 30.8557 30.3333 31.5V37.3333C30.3333 37.9777 30.8557 38.5 31.5 38.5H37.3333C37.9777 38.5 38.5 37.9777 38.5 37.3333V31.5C38.5 30.8557 37.9777 30.3333 37.3333 30.3333Z"
									stroke="white"
									strokeWidth="2"
									strokeLinecap="round"
								/>
								<path
									d="M24.5 30.3333H18.6667C18.0223 30.3333 17.5 30.8557 17.5 31.5V37.3333C17.5 37.9777 18.0223 38.5 18.6667 38.5H24.5C25.1443 38.5 25.6667 37.9777 25.6667 37.3333V31.5C25.6667 30.8557 25.1443 30.3333 24.5 30.3333Z"
									stroke="white"
									strokeWidth="2"
									strokeLinecap="round"
								/>
						...
						<span className="fw-bold plannr-logo-text">Plannr</span>
					</a>
				...
				<div className="d-flex align-items-center gap-3">
					<div className="search-box d-none d-sm-flex align-items-center">
						<span className="search-placeholder text-truncate">
							Search everything...
						</span>
						<kbd className="search-shortcut">/</kbd>
						<svg
							className="search-icon ms-1 flex-shrink-0"
							width="14"
							height="14"
							viewBox="0 0 28 28"
							fill="none"
						...
						>
							<path
								d="M24.5002 24.5002L19.4369 19.4369M22.1667 12.8333C22.1667 17.988 17.988 22.1667 12.8333 22.1667C7.67868 22.1667 3.5 17.988 3.5 12.8333C3.5 7.67868 7.67868 3.5 12.8333 3.5C17.988 3.5 22.1667 7.67868 22.1667 12.8333Z"
								stroke="#44546F"
								strokeWidth="3"
								strokeLinecap="round"
							/>
